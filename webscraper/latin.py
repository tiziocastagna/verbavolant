...
from italian import find_italian_verb
...
def find_latin_verb(verb_name, coniugazione):
    ...
    Verb = {"identifier": verb_name.upper(), "conuigazione": coniugazione, "translation": translations, "valid_translations": valid_translations, "INDICATIVO": {}, "CONGIUNTIVO": {}}
